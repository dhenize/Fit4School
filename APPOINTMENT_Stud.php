...
<html lang="en">
  ...
  <head>
    ...
    <style>
      ...
      .SD_btn:hover > .sd_icon{
          content: url('Images/dashboard (4).png');
      }
  ...
  <body>
    <div class=" row">
      <div class="col-lg-2">
        <div class="Logo">
          <img src="images/Logo_Light.png" width="64px" height="64px">
          <span class="Logo_txt">Fit4School</span>
        </div>
        <div class="sm-cont">
          <div>
            <button class="SD_btn" onclick="location.href='DASHBOARDStud.php'"><img src="images/dashboard (5).png" class="sd_icon" style="padding-right: 10px;">Student Dashboard</button>
          </div>
          <div>
            <button class="App_btn" onclick="location.href='APPOINTMENT_Stud.php'"><img src="images/appointment.png" class="app_icon" style="padding-right: 10px;">Appointment</button>
          </div>
          <div>
            <button class="TH_btn" onclick="location.href='HISTORY_Stud.php'"><img src="images/clock (1).png" class="th_icon" style="padding-right: 10px;">Transaction History</button>
          </div>
        </div>
      ...
      <div class="container-fluid col-lg-10 scroll-container" style="max-height: 100vh; padding: 20px; max-width: 100%;">
        ...
        <div class="upm-cont">
          ...
          <div class="dp">
            ...
            <img src="images/user.png" height="40px" width="40px" alt="User Profile">
        ...
        <div class="main-container">
          ...
          <div class="left-panel" style="width: 1000px; max-width: 100%;">
            ...
            <div class="appointment-box box">
              <div style="color: #16423C; font-weight: bold;">
              ...
              <div class="product-grid">
                ...
                <div class="product-card">
                  <div class="card" style="background: #C4DAD2; border-radius: 15px; padding: 10px; text-align: center;">
                    ...
                    <img src="images/polo.png" alt="POLO (Boys)"
                            ...
                            <div class="modal-body">
                              <div class="row">
                                ...
                                <div class="col-sm-4 text-center" style="background-color: #16423C; border-radius: 15px; padding: 10px; width: 32%; height: 450px; margin-top: -50px;">
                                  ...
                                  <img src="images/polo.png" alt="POLO" style="width: 100%; height: 300px; border: 1px solid #C4DAD2; border-radius: 15px;">
                ...
                <div class="product-card">
                  <div class="card" style="background: #C4DAD2; border-radius: 15px; padding: 10px; text-align: center;">
                    ...
                    <img src="images/pantsboy.png" alt="PANTS (Boys)"
                      style="width: 100%; max-width: 300px; height: auto; border-radius: 10px; margin-bottom: 15px;">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col-sm-4 text-center" style="background-color: #16423C; border-radius: 15px; padding: 10px; width: 32%; height: 450px; margin-top: -50px;">
                                  ...
                                  <img src="images/pantsboy.png" alt="PANTS" style="width: 100%; height: 300px; border: 1px solid #C4DAD2; border-radius: 15px;">
                                  <br>
                                  <div style="margin-top: 10px; display: flex; justify-content: space-between; align-items: center;">
                                    <select class="form-control" id="sizeSelect" style="width: 78%; border-radius: 15px; color: #757575;">
                                      <option selected disabled>Choose your size...</option>
              ...
              <div class="product-grid">
                ...
                <div class="product-card">
                  <div class="card" style="background: #C4DAD2; border-radius: 15px; padding: 10px; text-align: center;">
                    ...
                    <img src="images/blouse.png" alt="BLOUSE (Girls)"
                      style="width: 100%; max-width: 300px; height: auto; border-radius: 10px; margin-bottom: 15px;">
                          ...
                          <div class="modal-content" style="transform: translateY(5%);">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col-sm-4 text-center" style="background-color: #16423C; border-radius: 15px; padding: 10px; width: 32%; height: 450px; margin-top: -50px;">
                                  <h4 class="modal-title" style="color: #fff; font-size: 25px;">₱250.00</h4>
                                  <img src="images/blouse.png" alt="BLOUSE" style="width: 100%; height: 300px; border: 1px solid #C4DAD2; border-radius: 15px;">
                                  <br>
                                  <div style="margin-top: 10px; display: flex; justify-content: space-between; align-items: center;">
                                    <select class="form-control" id="sizeSelect" style="width: 78%; border-radius: 15px; color: #757575;">
                                      <option selected disabled>Choose your size...</option>
                ...
                <div class="product-card">
                  <div class="card" style="background: #C4DAD2; border-radius: 15px; padding: 10px; text-align: center;">
                    ...
                    <img src="images/pantsgirl.png" alt="PANTS (Girls)"
                      style="width: 100%; max-width: 300px; height: auto; border-radius: 10px; margin-bottom: 15px;">
                          ...
                          <div class="modal-content" style="transform: translateY(5%);">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col-sm-4 text-center" style="background-color: #16423C; border-radius: 15px; padding: 10px; width: 32%; height: 450px; margin-top: -50px;">
                                  <h4 class="modal-title" style="color: #fff; font-size: 25px;">₱250.00</h4>
                                  <img src="images/pantsgirl.png" alt="PANTS" style="width: 100%; height: 300px; border: 1px solid #C4DAD2; border-radius: 15px;">
                                  <br>
                                  <div style="margin-top: 10px; display: flex; justify-content: space-between; align-items: center;">
                                    <select class="form-control" id="sizeSelect" style="width: 78%; border-radius: 15px; color: #757575;">
                                      <option selected disabled>Choose your size...</option>
              ...
              <div class="product-grid">
                ...
                <div class="product-card">
                  <div class="card" style="background: #C4DAD2; border-radius: 15px; padding: 10px; text-align: center;">
                    ...
                    <img src="images/petshirt.png" alt="peshirt (unisex)"
                      style="width: 100%; max-width: 300px; height: auto; border-radius: 10px; margin-bottom: 15px;">
                          ...
                          <div class="modal-content" style="transform: translateY(5%);">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col-sm-4 text-center" style="background-color: #16423C; border-radius: 15px; padding: 10px; width: 32%; height: 450px; margin-top: -50px;">
                                  <h4 class="modal-title" style="color: #fff; font-size: 25px;">₱250.00</h4>
                                  <img src="images/petshirt.png" alt="PET SHIRT" style="width: 100%; height: 300px; border: 1px solid #C4DAD2; border-radius: 15px;">
                                  <br>
                                  <div style="margin-top: 10px; display: flex; justify-content: space-between; align-items: center;">
                                    <select class="form-control" id="sizeSelect" style="width: 78%; border-radius: 15px; color: #757575;">
                                      <option selected disabled>Choose your size...</option>
                ...
                <div class="product-card">
                  <div class="card" style="background: #C4DAD2; border-radius: 15px; padding: 10px; text-align: center;">
                    ...
                    <img src="images/pepants.png" alt="pepants (Unisex)"
                      style="width: 100%; max-width: 300px; height: auto; border-radius: 10px; margin-bottom: 15px;">
                          ...
                          <div class="modal-content" style="transform: translateY(5%);">
                            ...
                            <div class="modal-body">
                              <div class="row">
                                <div class="col-sm-4 text-center" style="background-color: #16423C; border-radius: 15px; padding: 10px; width: 32%; height: 450px; margin-top: -50px;">
                                  <h4 class="modal-title" style="color: #fff; font-size: 25px;">₱250.00</h4>
                                  <img src="images/pepants.png" alt="PEPANTS" style="width: 100%; height: 300px; border: 1px solid #C4DAD2; border-radius: 15px;">
                                  <br>
                                  <div style="margin-top: 10px; display: flex; justify-content: space-between; align-items: center;">
                                    <select class="form-control" id="sizeSelect" style="width: 78%; border-radius: 15px; color: #757575;">
                                      <option selected disabled>Choose your size...</option>
            ...
            <div class="to-pay-box box" style="color: #16423C; background: #C4DAD2; border: 1px solid #16423C;">
              ...
              <div class="order-list" style="display: flex; flex-direction: column; gap: 15px; margin-top: 15px; background: #C4DAD2;">
                ...
                <div class="order-item" style="display: flex; align-items: center; background: #f9f9f9; padding: 10px; border-radius: 8px; background: #C4DAD2;">
                  <img src="images/polo.png" style="border: 2px solid #16423C; width: 60px; height: auto; border-radius: 8px;" />
            ...
            <div class="cart-box box" style="background-color: #C4DAD2; border: 1px solid #16423C; border-radius: 10px; padding: 15px; color: white; height: 569px; overflow-y: auto; display: flex; flex-direction: column; justify-content: space-between; overflow-y: auto;">
              <div>
                ...
                <div class="order-item" style="display: flex; align-items: center; justify-content: space-between; margin-bottom: 12px;">
                  <!-- Image -->
                  <img src="images/pantsgirl.png" alt="PANTS (GIRL)" style="width: 60px; height: auto; border-radius: 6px; border: 1px solid white; margin-right: 12px;">
