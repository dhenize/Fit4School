    ...
    <body>
        <div class="container-fluid row">
            <div class="col-lg-2">
                ...
                <div class="sm-cont">
                    <div>
                        <button class="SD_btn" onclick="location.href='DASHBOARDStud.php'"><img src="images/dashboard (4).png" class="sd_icon" style="padding-right: 10px;">Student Dashboard</button>
                    </div>
                    <div>
                        <button class="App_btn" onclick="location.href='APPOINTMENT_Stud.php'"><img src="images/appointment (1).png" class="app_icon" style="padding-right: 10px;">Appointment</button>
                    </div>
                    <div>
            ...
            <div class="col-lg-10">
                ...
                <div class="view-container">
                    ...
                    <div class="featured">
                        <div class="Slides">
                            <img src="images/Welcome to Fit4School.png">
                        </div>
                        <div class="Slides">
                            <img src="images/carosel1.png">
                        </div>
                        <div class="Slides">
                            <img src="images/carosel2.png">
                        </div>
                        ...
                        <div class="Slides">
                            <img src="images/carosel4.png">
                        </div>

                        <div class="Slides">
                            <img src="images/carosel5.png">
                        </div>

                        <div class="Slides">
                            <img src="images/carosel6.png">
                        </div>
                    ...
                    <div class="lbox-cont">
                        <div>
                            ...
                            <div class="notice">
                                <span style=" font-size: 20px; font-weight: bold; color: #16423C;"><img src="images/warning.png" height="11%" width="11%" style=" margin-right: 10px;">NOTICE</span>
                                <br>
                                <br>
