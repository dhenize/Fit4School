    ...
    <head>
        ...
        <style>
            ...
            .order {
                ...
                width: 370px;
                height: auto;
                /* Changed to auto for dynamic content */
                margin-left: auto;
                /* Align right within flex container */
                margin-top: 0;
                padding: 15px;
            ...
            .order i {
                ...
                font-style: normal;
                float: right;
                /* Use float for inline alignment */
                margin-left: 10px;
    ...
    <body style=" overflow-y: scroll;">
        ...
        <div class="statsapp-statsque">
            ...
            <div class="queueinfo">
                ...
                <div style="font-size: 45px; font-weight: 500; margin-top: -5px;">
                    Queue No.<?php echo htmlspecialchars($currentQueueNo); ?>
                </div>
                <div class="timetext" style="font-size: 25px; font-weight: 500; margin-top: -1px;">
                    <?php echo htmlspecialchars($currentQueueTime); ?>
                </div>

                <button class="btn call" onclick="callQueue()" style="background: #16423C; color: #EEF0E5;">
                    Call
                </button>
                ...
                <script>
                    ...
                    function callQueue() {
                        fetch('admindash.php?get_queue=1') // same file
                            .then(response => response.json())
                            .then(data => {
                                if (data.success) {
                                    const number = data.number;
                                    speak(`Queue number ${number}, please proceed to the counter.`);
                                } else {
                                    speak("There is no one in the queue.");
                                }
                            })
                            .catch(error => {
                                console.error('Fetch error:', error);
                                speak("Error fetching queue number.");
                            });
                    }
                </script>
