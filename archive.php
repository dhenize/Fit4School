...
try {
    ...
    function getArchivedAppointments(PDO $pdo, ?string $remarkFilter = null): array {
        $sql = "SELECT student_id, order_id, items, quantity, date_of_appointment, time_of_appointment, Total, remark FROM archive";
        $params = [];

        $allowedRemarks = ['ongoing', 'missed', 'done'];
        ...
        <div class="filter-dropdown-container">
            <form action="archive.php" method="GET" style="display:inline;">
                <select name="remark" id="remarkFilter" class="filter-select" onchange="this.form.submit()">
                    <option value="">All</option> <option value="missed" <?php echo ($remarkFilter == 'missed') ? 'selected' : ''; ?>>Missed</option>
                        ...
                        <tbody>
                            <?php foreach ($archivedAppointments as $appointment): ?>
                                <tr>
                                    ...
                                    <td><?php echo htmlspecialchars($appointment['remark']); ?></td>
                                </tr>
                            <?php endforeach; ?>
                        </tbody>
                    </table>
